...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex gap-3 h-fit items-center justify-center rounded-md bg-slate-200 p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
